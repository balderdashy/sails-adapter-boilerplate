...
var adapter = module.exports = (function() {
  ...
  function parseOne(connectionName, collectionName, values) {
    var i, names = [], name;
    for (i in values) {
  ...
  function parseMany(connectionName, collectionName, values) {
    var i, names = [], name;
    for (i in values) {
      if (values.hasOwnProperty(i)) {
  ...
  function toWhere(connectionName, collectionName, object, properties) {
    var i, query = [], q;
    for (i in properties) {
  ...
  function query(connectionName, collectionName, q, params, cb) {
  ...
  return {
    ...
    //   console.log(connectionName, collectionName, collection + ' Model registered');
    //   cb();
    // },
    ...
    // },
    // // REQUIRED method if integrating with a schemaful database
    // drop: function(connectionName, collectionName, cb) {
    ...
    create: function(connectionName, collectionName, params, cb) {
      ...
      query(connectionName, collectionName, q, params, cb);
    },

    createMany: function(connectionName, collectionName, params, cb) {
      // Create a single new model specified by values
      var q, delimiter = '';
    ...
    find: function(connectionName, collectionName, params, cb) {
